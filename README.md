...
მაგალითად, ეს არის `analyze_scores` ფუნქცია, რომელსაც გადმოეცემა ქულების მასივი. ამ მასივს სორტავს ეს კოდი და აბრუნებს საშუალო ქულას + `bonus` იმის მიხედვით როგორი ქულებია ამ მასივში (ანუ მაქსიმალური ქულა თუ 100-ია და ა.შ):
...
| 10 | HBinSim | იერარქიული (insn → ბლოკი → გრაფი) | **0.499**\*\* | 0.576 | 0.409 | 0.484 | 0.602 | 0.689 | 0.706 | 0.635 | 0.515 | 0.988 |
